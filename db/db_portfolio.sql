...
CREATE TABLE `tbl_section` (
  ...
  `section_link` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(3, 'Pure Volume', 'CSS Grid | Interactive Timeline | JavaScript Video Player', 'During the first week of fourth year, my class was tasked with working in groups to create a website rebrand for Purevolume.com. I managed the group to ensure the designer, videographer, and two front end developers completed their work on time. I also created the website copy and crafted the presentation we delivered to the client, Hive Media.', 'https://github.com/EmmaBlue/Blue_E_Angelozzi_C_Atkinson_J_Unger_H_Boyden_D_PUREVOLUME'),
(4, 'InterAction Collective', 'Flat Design Logo ', 'I designed a logo for the grassroots youth group I supported in its early development called the InterAction Collective. I wanted to create a bold, visually accessible logo that highlights interaction and works in a variety of different colours. ', 'https://www.facebook.com/InterActionCollectiveOnt/'),
(5, 'Blue Fyre', 'CSS Grid | JavaScript Slider', 'I designed and coded a website for an agency called Blue Fyre. I created a lightbox slider to showcase our portfolio work and used CSS Grid to create a full-width portfolio section.', 'https://github.com/EmmaBlue/Blue_E_Stoltz_Limin_S_AgencyX'),
(6, 'These Sites Save Lives', 'CSS Grid | Fetch API | Responsive GreenSock Animation', 'I designed and developed this interactive infographic website to highlight the importance of supervised consumption sites within London.  I used the Fetch API to call custom SVGs from the database when the user clicks on information about the services supervised consumption sites offer. I also used the GreenSock library to create the heartbeat and staggered people animation.', 'https://github.com/EmmaBlue/Blue_E_Interactive_Infographic'),
(7, 'Demo Reel', 'Cinema 4D | Adobe After Effects', 'I created a demo reel of all of my best 3D animation work. This video includes a bedroom build, cosmetic products, a Mondrian chair, and a logo animation.', ''),
(8, 'Arielle Kayabaga Campaign', 'Logo and Postcard Design', 'I worked with current Ward 13 city councillor Arielle Kayabaga on her campaign to create her logo and campaign sign design. I created two different versions of the design that Arielle used on postcards, online promo material, and signage. I used bright, friendly colours and distinctive sans-serif fonts to communicate Arielle’s approachable style of politics.', 'https://ariellekayabaga.com/'),
...
(1, 'mobile.mp4', 'tablet.mp4', 'desktop.mp4', '');
